  ...
  return (
    <RevealGroup className="space-y-12">
      ...
      <section>
        ...
        <div className="rounded-lg border border-line dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[color:var(--surface-1)] p-6">
            ...
            {overnight.map((o) => {
              ...
              return (
                <Link
                  ...
                  className="rounded-lg border border-line dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[color:var(--surface-1)] p-4 hover:border-[color:var(--brand-night)] dark:hover:border-white/30 transition-colors group"
                >
