...
export interface BoardRow { stage: string; count: number; color: string; chips: BoardChip[]; }
...
export interface DecisionCard { title: string; body: string; decide: string; }
...
const WEEK_2026_07_06: V2Week = {
  ...
  journey: {
    ...
    milestones: [
      ...
      { text: "first snapshot" },
      { text: "inflow peaks" },
      { text: "JBI renews $162K", good: true },
    ],
